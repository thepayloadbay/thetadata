...
- **VIX1D/VVIX/VIX9D signals** (TradingView data): full sweep across 4 conditions × 5 SL levels. All backwardation (162 days): -$77k to -$89k. Back+VVIX>=100 (67 days): -$39k to -$47k. Back+VVIX>=120 (14 days): -$5k to -$10k. Deep backwardation spread<-3 (58 days): -$25k to -$37k. Every combination worse than baseline at every SL level (-$300 to -$1500). Skip filters also cost P&L at every threshold. 8 of 10 worst loss days have positive spread + normal VVIX — signals don't identify them. Data integrated into indicator pipeline (dVix1d, dVix9d, dVvix, dVixTermSpread, dVix1dVixRatio) but no filter implemented
