...
- **VIX1D/VVIX/VIX9D term structure signals** (TradingView data): Two full sweeps (VIX1D and VIX9D), 8 conditions × 5 SL levels each. VIX1D backwardation: -$5k to -$91k across all combos. VIX9D backwardation: -$16k to -$151k. Narrowest (VIX9D back+VIX15-20, 71 days) still costs -$16k at loosest SL. Paradox: VIX9D backwardation in VIX 15-20 has 95.7% WR and $796/day — one of the BEST subsets. Skip filters also cost P&L at every threshold. Only 4 of 15 worst loss days had VIX9D backwardation; biggest loss (Oct 9 2023) was barely inverted. Covers TODO items 1 (VX1 proxy) and 3 (VIX9D filter). Data in pipeline (dVix1d, dVix9d, dVvix, dVixTermSpread, dVix1dVixRatio, dVix9dVixRatio) but no filter implemented
